...
model = pickle.load(open('Crop-Prediction-and-Disease-Detection-new-main\model.pkl', 'rb'))
sc = pickle.load(open('Crop-Prediction-and-Disease-Detection-new-main\standscaler.pkl', 'rb'))
ms = pickle.load(open('Crop-Prediction-and-Disease-Detection-new-main\minmaxscaler.pkl', 'rb'))
